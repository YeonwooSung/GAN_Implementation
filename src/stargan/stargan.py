...
if __name__ == "__main__":
    ...
    batch_size, n_cpu, sample_interval, checkpoint_interval = args.batch_size, args.n_cpu, args.sample_interval, args.checkpoint_interval
    img_height, img_width, channels = args.img_height, args.img_width, args.channels
    lr, b1, b2 = args.lr, args.b1, args.b2
    residual_blocks, selected_attrs = args.residual_blocks, args.selected_attrs
