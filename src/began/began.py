...
if __name__ == "__main__":
    ...
    # arg parser
    args = arg_parse()
    channels, img_size, batch_size, latent_dim = args.channels, args.img_size, args.batch_size, args.latent_dim
    lr, b1, b2 = args.lr, args.b1, args.b2
    n_epochs, sample_interval = args.n_epochs, args.sample_interval
